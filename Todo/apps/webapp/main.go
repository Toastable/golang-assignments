...
func main() {
	...
	httpServer.HandleFunc("/edit/{id}", web_server.EditTodoHandler)
	httpServer.HandleFunc("/update", web_server.EditTodoHandler)
	httpServer.HandleFunc("/delete/{id}", web_server.DeleteTodoHandler)
